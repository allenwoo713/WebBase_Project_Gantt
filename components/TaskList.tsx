...
import { Task, ROW_HEIGHT, Member, Priority, TaskStatus } from '../types';
        ...
        <div className="min-w-[1400px]"> 
            ...
            <div>
                ...
                {tasks.length < 15 && Array.from({ length: 15 - tasks.length }).map((_, i) => (
                    <div key={`empty-${i}`} className="min-w-[1400px] flex items-center border-b border-gray-50" style={{ height: ROW_HEIGHT }}>
