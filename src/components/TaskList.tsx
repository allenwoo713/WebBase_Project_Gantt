...
import { formatDate, calculateTaskCost } from '../utils';
            ...
            <div className="flex-1 overflow-auto">
                <div className="min-w-[2000px]">
                    ...
                    <div className="flex items-center bg-gray-50 border-b border-gray-200 font-semibold text-xs text-gray-500 sticky top-0 z-10" style={{ height: 50 }}>
                        ...
                        <div className="w-24 px-2 border-l border-gray-100 shrink-0">Plan Cost</div>
                        <div className="w-24 px-2 border-l border-gray-100 shrink-0">Actual Cost</div>
                    ...
                    <div>
                        {tasks.map((task, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Plan Cost */}
                                    <div className="w-24 px-2 border-l border-gray-100 shrink-0 text-right text-xs text-gray-600">
                                        {costs.plan > 0 ? `$${costs.plan.toLocaleString()}` : '-'}
                                    </div>

                                    {/* Actual Cost */}
                                    <div className="w-24 px-2 border-l border-gray-100 shrink-0 text-right text-xs text-gray-600">
                                        {costs.actual > 0 ? `$${costs.actual.toLocaleString()}` : '-'}
                                    </div>
                        ...
                        {tasks.length < 15 && Array.from({ length: 15 - tasks.length }).map((_, i) => (
                            <div key={`empty-${i}`} className="min-w-[2000px] flex items-center border-b border-gray-50" style={{ height: ROW_HEIGHT }}>
